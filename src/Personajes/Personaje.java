...
public class Personaje {
    ...
    private String clase; /** Atributo tipo String que define la subclase del personaje */
     ...
     */
    public Personaje(String nombre, int atq, int arm, int pv,int nivel, int res, int vel, String raza, String clase){
        setNombre(nombre);
        setPv(pv);
        setAtq(atq);
        setArm(arm);
